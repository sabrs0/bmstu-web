...
func NewFoundationController(FS servs.IFoundationService, TS servs.ITransactionService,
	FgS servs.IFoundrisingService) *FoundationController {
...
func (UC *FoundationController) Delete(id string) error { //это делают триггеры (каскадное удаление)
	err := UC.FS.Delete(id)
	/*if err == nil {
