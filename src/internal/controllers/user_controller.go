...
import (
	...
	"github.com/sabrs0/bmstu-web/src/internal/business/checker"
...
func NewUserController(FS servs.IFoundationService, FgS servs.IFoundrisingService,
	TS servs.ITransactionService, US servs.IUserService) *UserController {
...
func isNewPhilantrop(TS servs.ITransactionService, FgS servs.IFoundrisingService, foundrisingId string, userId uint64) (bool, error) {
