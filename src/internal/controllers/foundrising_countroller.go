...
type FoundrisingController struct {
	FS   servs.IFoundrisingService
	FndS servs.IFoundationService
}

func NewFoundrisingController(FS servs.IFoundationService, FgS servs.IFoundrisingService) *FoundrisingController {
